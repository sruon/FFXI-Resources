...
class EndLoadSchedulerMainOpcode(SchedulerBase):
    opcode = 0xA1
    name = "END_LOAD_SCHEDULER_MAIN"
    ...
    def get_legible_representation(self, raw_bytes: bytes, args=None, context=None):
        ...
        return f"END_LOAD_SCHEDULER_MAIN: End scheduler {scheduler_display} with entities [{entity1_str}, {entity2_str}], work={work_str}"
