...
class EndLoadSchedulerMainAlt6Opcode(SchedulerBase):
    opcode = 0xBD
    name = "END_LOAD_SCHEDULER_MAIN_ALT6"
    ...
    def get_legible_representation(self, raw_bytes: bytes, args=None, context=None):
        ...
        return f"END_LOAD_SCHEDULER_MAIN_ALT6: End scheduler {scheduler_display} with entities [{entity1_str}, {entity2_str}], work={work_str}"
