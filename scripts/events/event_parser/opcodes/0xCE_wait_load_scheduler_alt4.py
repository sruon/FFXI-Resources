...
class WaitLoadSchedulerAlt4Opcode(SchedulerBase):
    """Waits for load scheduler with alternate configuration (helper call 70435)"""

    opcode = 0xCE
    name = "WAIT_LOAD_SCHEDULER_ALT4"
    ...
    def get_legible_representation(self, raw_bytes: bytes, args: dict = None, context=None) -> str:
        ...
        return f"WAIT_LOAD_SCHEDULER_ALT4: Wait for scheduler {scheduler_id_str} with entities [{entity1_str}, {entity2_str}], work={work_str}"
