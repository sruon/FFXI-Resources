...
class EndLoadSchedulerOpcode(SchedulerBase):

    opcode = 0x52
    name = "END_LOAD_SCHEDULER"
    ...
    def get_legible_representation(self, raw_bytes: bytes, args=None, context=None):
        ...
        return f"END_LOAD_SCHEDULER: End scheduler {scheduler_display} with entities [{entity1_str}, {entity2_str}], work={work_str}"
